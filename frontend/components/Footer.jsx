    ...
    <footer className="border-t border-black/5 bg-[#f5f1ea] text-cedar">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1.3fr_1fr_1fr] lg:px-8">
        ...
        <div className="text-sm">
          ...
          <a className="mt-3 block text-cedar/62 transition hover:text-ember" href={`tel:${business.phone}`}>
            {business.phone}
          </a>
          <a className="mt-2 block text-cedar/62 transition hover:text-ember" href={safeExternalUrl(business.instagram)} target="_blank" rel="noreferrer">
            Instagram
          </a>
